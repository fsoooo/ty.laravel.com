...
Mask.prototype.confirm = function(msg,confirmcallback) {
	var _this = this;
	var html = '<div class="mask mask-confirm"><div class="mask-bg"></div><div class="mask-container"><p>' + msg + '</p><div class="mask-btn-box"><button class="mask-btn mask-btn-cancel">取消</button><button class="mask-btn mask-btn-confirm">确定</button></div></div></div>';
	_this.open(html);
...
// function psOrcpn(ele,callback){
//     var ele1 = $(ele).find('select:first-child');
//     var ele2 = $(ele).find('select:nth-child(2)');
//     var personObj = {"1" :'姓名',"2" :'身份证',"3" :'手机号',"4" :'邮箱'};
//     var companyObj = {"1" :'公司名称',"2" :'统一信用代码',"3" :'组织机构代码',"4" :'营业执照编码',"5" :'纳税人识别号'};
//     var returnObj = {};
//     ele1.change(function(){
//         var obj;
//         $(this).val() == 1 ? obj = personObj : obj = companyObj;
//         var html = '';
//         $.each(obj, function(i, val) {
//             html += '<option value="'+ i +'">'+ val +'</option>'
//         });
//         $(this).next().empty().append(html);
//         returnObj.target = $(this);

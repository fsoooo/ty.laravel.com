$(function() {
	...
	$(document).scroll(function() {
		...
		function active(index){
			ele.anchorlinkitem.eq(index).addClass('active').siblings().removeClass('active');
		}
	});
	...
	$('.popup-list th').click(function() {
		...
		$('.popup-list tbody tr').each(function(index) {
			...
			$(this).find('td').eq(selectedindex).addClass('label-active');
		})
	});
	// // json格式转换
	...
	$('.popup .product-type').not('.all').click(function() {
		$('.popup .all').removeClass('label-active');
	...
	$('.popup .all').click(function() {
		$('.popup .product-type').removeClass('label-active');
		if ($(this).hasClass('label-active')) {
			$(this).removeClass('label-active');
		} else {
			$(this).addClass('label-active');

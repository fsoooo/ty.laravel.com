...
<div id="email-detail-inner">
    <div id="email-detail-subject" class="clearfix">
        ...
        <div id="email-detail-subject" class="clearfix">
            <span class="subject">
                <img  src="{{config('curl_product.company_logo_url')}}/{{substr($json['company']['logo'],0,1)=="/"?substr($json['company']['logo'],1):$json['company']['logo']}}" style="height: 40px;width:80px;">

        ...
        <div class="col-lg-12">
            ...
            <div class="main-box clearfix">
                ...
                <ul class="nav nav-tabs">
                    ...
                    <li class="active"><a href="{{ url('backend/sell/ditch_agent/agents/create') }}">新建代理人</a></li>
                </ul>
                ...
                <div class="main-box-body clearfix">
                    <form role="form" id="add_agent" action='{{url('backend/sell/ditch_agent/post_add_agent')}}' method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label for="exampleInputPassword1">代理人姓名<span class="red">*</span></label>
                            <input class="form-control" name="real_name" value="{{ old('real_name') }}"  type="text">
                        </div>
                        <div class="form-group">
                            <label for="exampleTextarea">工号<span class="red">*</span></label>
                            <input class="form-control" name="job_number" value="{{ old('job_number') }}"  type="text">
                        </div>
                        <div class="form-group">

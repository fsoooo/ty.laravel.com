									...
									<div class="tab-pane fade in active" id="tab-accounts">
										...
										<div class="panel-group accordion" id="operation">
											<div class="panel panel-default">
												<form action="{{ url('/backend/authentication/submit/'.$id) }}" method="post" id="send-message-form">
													{{ csrf_field() }}
													<table id="user" class="table table-hover" style="clear: both">
														...
														<tr>
															<td width="15%">公司名称</td>
															<td width="60%">
																<input type="text" class="form-control" value="{{$res[0]->name}}" name="name" disabled>
															</td>
														</tr>
														<tr>
															<td width="15%">公司三合一码</td>
															<td width="60%">
																<input type="text" class="form-control" value="{{$res[0]->code}}"  name="code" disabled>
															</td>
														</tr>
														<tr>
															<td width="15%">公司法人</td>
															<td width="60%">
																<input type="text" class="form-control" value="{{$res[0]->boss}}"  name="boss" disabled>
															</td>
														</tr>
														<tr>
															<td width="15%">认证状态</td>

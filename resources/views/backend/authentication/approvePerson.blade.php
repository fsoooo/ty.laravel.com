                    ...
                    <div class="col-lg-12">
                        <div class="main-box clearfix" style="min-height: 1100px;">
                            ...
                            <ul class="nav nav-tabs">
                                <li><a href="{{url('backend/authentication/index/untreated')}}">公司认证列表</a></li>
                                <li class="active"><a href="{{url('backend/authentication/approvePerson')}}">个人认证列表</a></li>
                            </ul>
                            <div class="tab-content">
                                <div class="tab-pane fade in active" id="tab-accounts">
                                    ...
                                    <table id="user" class="table table-hover" style="clear: both">
                                        ...
                                        @if($count == 0)
                                            <tr>
                                                <td colspan="7" style="text-align: center;">暂无需要处理的数据</td>
                                            </tr>
                                        @else
                                            @foreach($res as $value)
                                                <tr>
													...
													<td style="text-align: center"><img src="{{url($value->card_img_person)}}" alt="" style="width: 200px"></td>
                                                    @if($value->status == 1)
													...
													@endif
													<td style="text-align: center"><a href="{{url('backend/authentication/dealPerson/'.$value->id)}}"><button type="button" class="btn btn-success">处理</button></a></td>
                                                </tr>
                                            @endforeach
                                        @endif
                                        </tbody>

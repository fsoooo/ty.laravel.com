                                                ...
                                                <form action="{{ url('/backend/sms/send_message') }}" method="post" id="send-message-form">
                                                    ...
                                                    <table id="user" class="table table-hover" style="clear: both">
                                                        ...
                                                        <tr id="designated-cust-block" hidden>
                                                            <td>指定成员</td>
                                                            <td>
                                                                <input id="name"><input type="button" id="search" value="搜索">
                                                            </td>
                                                        </tr>
                                                        <tr id="choose">
                                                            <td><input type="hidden" name="id" id="check"></td>
                                                            <td id="span">
                                                        ...
                                                        <tr id="designated-time-block" hidden>
                                                            ...
                                                            <td>
                                                                ...
                                                                <input hidden type="text" id="designated-time">
                                                            </td>
                                                        </tr>
                                                        </tbody>
                                                    </table>
    ...
    <script>
        $(function(){
            $("#search").click(function(){
                var name=$('#name').val();
                $("#choose").removeAttr('hidden');
                $.ajax({
                    type: "GET",
                    url: "/backend/sms/search/",
                    data: "name="+name,
                    dataType:"json",
                    success: function(msg) {
                        var str = "";
                        for (i = 0; i < msg.length; i++) {
                            str += "<input type='checkbox' name='test' value="+msg[i]['id']+"><span id='span'><span>"+msg[i]['name']+"</span>";
                        }
                        $('#span').html(str);
                    }
                });

                        ...
                        <div class="main-box clearfix" style="min-height: 1100px;">
                            <div class="tabs-wrapper tabs-no-header">
                                <ul class="nav nav-tabs">
                                    @if($type == 'user')
                                        <li  class="active"><a href="/backend/maintenance/change_data/user">个险变更</a></li>
                                        <li><a href="/backend/maintenance/change_person">团险变更</a></li>
                                            ...
                                            @else
                                                @foreach($list as $value)
                                                    <tr>
                                                        ...
                                                        <td><a href="{{ url('/backend/maintenance/change_data_detail/'.$value->union_order_id) }}" target="_blank">更多修改内容</a></td>
                                                        <td><a href="{{ url('/backend/maintenance/change_data_submit/'.$value->union_order_id) }}" target="_blank">提交变更</a></td>
                                                    </tr>
                                                @endforeach
                                            @endif
                                        </tbody>

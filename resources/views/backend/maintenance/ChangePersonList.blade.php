                ...
                <div class="row">
                    <div class="col-lg-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="active"><span>团险变更</span></li>
                        </ol>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="tabs-wrapper tabs-no-header">
                            <ul class="nav nav-tabs">
                                <li><a href="/backend/maintenance/change_data/user">个险变更</a></li>
                                <li class="active"><a href="/backend/maintenance/change_person">团险变更</a></li>
                            </ul>
                        @include('backend.layout.alert_info')
                        <div class="main-box">
                            <header class="main-box-header clearfix">
                                <h2 class="pull-left">团险变更</h2>
                            </header>

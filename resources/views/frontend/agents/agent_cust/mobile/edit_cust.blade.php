...
<div class="main">
    ...
    <div class="mui-content add">
        <form action="/agent_sale/edit_cust_submit" method="post" id="form" enctype="multipart/form-data">
                    ...
                    <div class="form-wrapper">
                        ...
                        <ul>
                            <li>
                                ...
                                <input class="mustFill" id="Name" name="name" value="{{isset($detail["real_name"])?$detail["real_name"]:''}}" type="text" placeholder="请填写真实姓名" />
                            </li>
                            <li class="radioBox">
                                <span class="name">性别</span>
                                <div class="select-box">
                                    <span class="zbtn-select @if(isset($detail['code']) && substr($detail['code'],16,1)%2 == 0)  active @endif ">女</span>
                                    <span class="zbtn-select @if(isset($detail['code']) && substr($detail['code'],16,1)%2 == 1)  active @endif  ">男</span>
                                </div>
                            ...
                            <li>
                                ...
                                <input class="mustFill" id="IdCard" type="text" placeholder="必填" value="{{isset($detail['code'])?$detail['code']:''}}" name="id_code" />
                            </li>
                            <li>
                                <span class="name">职业</span>
                                <input class="mustFill" type="text" placeholder="必填" value="{{isset($detail['occupation'])?$detail['occupation']:''}}" name="occupation" />
                            </li>
                            <li>
                                <span class="name">手机号码</span>
                                <input class="mustFill" id="Tel" type="tel" maxlength="11" value="{{isset($detail['phone'])?$detail['phone']:''}}" placeholder="必填" name="phone" />
                            </li>
                            <li>
                                <span class="name">邮箱地址</span>
                                <input class="mustFill" id="Email" type="text" value="{{isset($detail['email'])?$detail['email']:''}}" placeholder="必填" name="email" />
                            </li>
                            <li>
        ...
        <div class="button-box">
            <button id="create" class="zbtn zbtn-default" disabled>提交</button>
        </div>

                ...
                <div class="row">
                    <div class="col-lg-12">
                        <ol class="breadcrumb">
                            ...
                            <li><span><a href="/agent_task/add_warranty">线下保单录入</a></span></li>
                            <li><a href="/agent_task/warranty_list">查看已录入保单</a></li>
                        ...
                        <div class="main-box clearfix" style="min-height: 1100px;">
                            <div class="tabs-wrapper tabs-no-header">
                                {{--<ul class="nav nav-tabs">--}}
                                    ...
                                    {{--<li class="active"><a href="/agent_task/warranty_list">查看已录入保单</a></li>--}}
                                    {{--<li class="active"><a href="#">保单详情</a></li>--}}
                                {{--</ul>--}}

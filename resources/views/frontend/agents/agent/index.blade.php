                ...
                <div class="row">
                    <div class="col-lg-12">
                        <ol class="breadcrumb">
                            ...
                            @if($type == 'all')
                                <li class="active"><a href="{{ url('/agent/index/all') }}">所有代理客户</a></li>
                            @elseif($type == 'person')
                                <li class="active"><a href="{{ url('/agent/index/person') }}">代理的个人客户</a></li>
                            @elseif($type == 'company')
                                <li class="active"><a href="{{ url('/agent/index/company') }}">代理的企业客户</a></li>
                            @endif
                        </ol>
                    </div>
                </div>
                        ...
                        <div class="main-box clearfix" style="min-height: 1100px;">
                            <div class="tabs-wrapper tabs-no-header">
                                <ul class="nav nav-tabs">
                                    @if($type == 'all')
                                        <li class="active"><a href="{{ url('/agent/index/all') }}">所有代理客户</a></li>
                                        <li><a href="{{ url('/agent/index/person') }}">代理的个人客户</a></li>
                                        <li><a href="{{ url('/agent/index/company') }}">代理的企业客户</a></li>
                                    @elseif($type == 'person')
                                        <li><a href="{{ url('/agent/index/all') }}">所有代理客户</a></li>
                                        <li class="active"><a href="{{ url('/agent/index/person') }}">代理的个人客户</a></li>
                                        <li><a href="{{ url('/agent/index/company') }}">代理的企业客户</a></li>
                                    @elseif($type == 'company')
                                        <li><a href="{{ url('/agent/index/all') }}">所有代理客户</a></li>
                                                    ...
                                                    @else
                                                        @foreach ( $list as $value )
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    @if($value->type == 0)
                                                                        <a href="{{ url('/agent/index/person') }}">个人客户</a>
                                                                    @else
                                                                        <a href="{{ url('/agent/index/company') }}">企业客户</a>
                                                                ...
                                                                <td>
                                                                    <div class="btn-group">
                                                                        ...
                                                                        <ul class="dropdown-menu">
                                                                           <li><a href="{{ url('/agent/evolve/'.$value->code).'/'.$value->id }}">查看</a></li>
                                                                            <li><a href="{{ url('/agent/add_evolve/'.$value->id) }}">添加</a></li>
                                                                        </ul>
                                                                    </div>
                                                                </td>
                                                                <td>

        ...
        <div class="mui-scroll-wrapper">
            <div class="mui-scroll">
                ...
                <div class="info-wrapper">
                    ...
                    <div class="form-wrapper">
                        <ul>
                            <li>
                                ...
                                <input type="text" placeholder="请填写真实姓名" readonly />
                            </li>
                            <li>
                            ...
                            <li>
                                ...
                                <input type="text" placeholder="必填" readonly />
                            </li>
                            <li>
                            ...
                            <li>
                                ...
                                <input type="text" maxlength="11" placeholder="必填" readonly />
                            </li>
                            <li>
                    ...
                    <button class="zbtn zbtn-positive center">提交</button>
                </div>
            </div>
        </div>
    </div>
    <div class="button-box">
        <button id="send" class="zbtn zbtn-default">发给客户</button>
    </div>
</div>
...
<script>
    ...
    clipboard.on('success', function(e) {
        ...
        location.href = '/agent_sale/agent_invite_success';
    });
</script>
{{--分享--}}

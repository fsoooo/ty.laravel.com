                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <table class="insured_table">
                                                ...
                                                {{--<tr class="insured_lists" list-num="1">--}}
                                                    {{--<td><input type="text" name="insurance_attributes[ty_beibaoren][1][ty_beibaoren_name]"></td>--}}
                                                    {{--<td class="id_number"><input type="text" name="insurance_attributes[ty_beibaoren][1][ty_beibaoren_id_number]"></td>--}}
                                                    {{--<td><input type="text" name="insurance_attributes[ty_beibaoren][1][ty_beibaoren_job]"></td>--}}
                                                    {{--<td><input type="text" name="insurance_attributes[ty_beibaoren][1][ty_beibaoren_phone]"></td>--}}
...
//                    html += '<td><input type="text" name="insurance_attributes[ty_beibaoren]['+$num+']['+persons[i][0]+']"></td>';
                    for(n in persons[i]){
                        html += '<td>' +

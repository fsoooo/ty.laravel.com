                                            ...
                                            <div class="panel panel-default">
                                                ...
                                                <table id="user" class="table table-hover" style="clear: both">
                                                    ...
                                                    <tr>
                                                        <td>身份证正面</td>
                                                        <td>
                                                            <input type="file" name="card_img_front" value="" class="form-control">
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>身份证反面</td>
                                                        <td>
                                                            <input type="file" name="card_img_backend" value="" class="form-control">
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>手持照片</td>
                                                        <td>
                                                            <input type="file" name="card_img_person" value="" class="form-control">
                                                        </td>
                                                    </tr>
                                                    {{--@if(!$information->code)--}}

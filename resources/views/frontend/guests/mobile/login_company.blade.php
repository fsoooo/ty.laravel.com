        ...
        <div class="mui-scroll">
            ...
            <div class="login-wrapper">
                <form action="/phone_login" class="form" id="login_form_phone" method="post">
                    ...
                    <ul>
                        <li>
                            <input type="text" name="phone" id="phone_input" placeholder="手机号" autocomplete="off"/>
                        </li>
                        <li>
                ...
                <div type="button" style="margin-top: 15px" class="btn-password" >使用密码登录</div><br/>
            </div>
            <div class="login-wrapper hide">
                ...
                <ul>
                    <form action="{{url('/do_login_company')}}" method="post" id="form_password" onsubmit="return doLogin()">
                        {{ csrf_field() }}
                        <li>
                            <input type="text" id="phone_person" name="email" placeholder="邮箱/证件号" autocomplete="off"/>
                        </li>
                        <li>

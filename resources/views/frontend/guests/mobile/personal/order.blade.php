        ...
        <div class="mui-scroll-wrapper">
            <div class="mui-scroll">
                <ul class="guarantee-wrapper">
                    ...
                    <li>
                        <a href="/order/detail/{{$v['id']}}"><div class="guarantee-code">订单号：{{$v['order_code']}}<span class="status fr">@if($v['status'] == 2)待支付@else已支付@endif</span></div></a>
                        ...
                        <div class="btn-wrapper">
                            ...
                            @if($v['status'] == 2)
                                <a href="{{ url('/ins/pay_again/'.$v->warranty_rule->union_order_code) }}" class="btn-primary">立即支付</a>
                            @else

            ...
            <div class="mui-scroll">
                <div class="applicant-wrapper">
                    <ul class="applicant-partone">
                        <li class="approve">
                            <a href="/information/approvePerson"><span class="name">实名认证</span><i class="iconfont icon-gengduo"></i></a>
                        </li>
                        <li>
                            <a href="/mpersonal/contact"><span class="name">常用联系人</span><i class="iconfont icon-gengduo"></i></a>
                        </li>
                        <li>
                            <a href="/mpersonal/chang_psw"><span class="name">密码修改</span><i class="iconfont icon-gengduo"></i></a>
                        </li>
                        <li>
                            <a href="/mpersonal/info"><span class="name">个人信息</span><i class="iconfont icon-gengduo"></i></a>
                        </li>
                    </ul>
                </div>
            </div>

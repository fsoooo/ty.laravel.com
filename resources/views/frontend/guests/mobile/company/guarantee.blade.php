                ...
                <ul class="guarantee-wrapper">
                    ...
                    <li>
                        ...
                        <div class="guarantee-info">
                            ...
                            <p>被保人：
                                @foreach($v['warranty_recognizee'] as $v)
                                    {{ $v->name }}
                                @endforeach</p>
                            <p>保障时间：{{strtok($v['start_time'],' ')}}至{{isset($v['end_time'])?strtok($v['end_time'],' ') : date("Y-m-d",strtotime("+1 year",strtotime($v['start_time'])))}}</p>

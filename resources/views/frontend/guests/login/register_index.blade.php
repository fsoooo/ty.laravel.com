...
<div class="banner">
    ...
    <div class="main">
        ...
        <div class="wrapper">
			...
			<div class="buttonbox">
				<a href="/register/person"><button><i class="iconfont icon-yonghudenglu"></i>个人注册</button></a>
				<a href="/register/company"><button><i class="iconfont icon-duoren"></i>企业注册</button></a>
				{{--<a href="/register/group"><button><i class="iconfont icon-duoren"></i>团体/组织注册</button></a>--}}
			</div>
        </div>
    </div>
</div>

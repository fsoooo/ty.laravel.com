...
@section('content')
        ...
        <div class="login-block-wrap">
            <div class="login-block">
                        ...
                        <div class="relevance">
                            ...
                            @if($path == "dev312.inschos.com")
                                <a href="https://open.weixin.qq.com/connect/qrconnect?appid=wxe1d4164a739689d2&redirect_uri=http%3A%2F%2Fdev312.inschos.com%2Fwe_chat&response_type=code&scope=snsapi_login&state=46F94C8DE14FB36680850768FF1B7F2A" style="margin-left: -20px">
                                    <img src="{{config('view_url.view_url').'image/weixin.jpg'}}" style="border-radius: 8px;margin-bottom: -10px;">
                                </a>
                            @endif
                        </div>
                        @else
                ...
                <div class="account-block login-type-block" hidden>
                    <form role="form" action="{{url('/do_login')}}" method="post" class="form" onsubmit="return check_user_name()">
                        <input type="hidden" name="_token" value="{{ csrf_token() }}">
                        <div class="user-name">
                                <input type="text" id="user_name"  name="phone" class="input" name="user_name" placeholder="手机/邮箱/身份证号">
                        </div>
                        <div class="password">
    ...
    <script>
        function check_user_name() {
            ...
            var user_type = reg.test(user_name);
            if(user_type){
                ...
                if(!user_name||user_name.length < 11){

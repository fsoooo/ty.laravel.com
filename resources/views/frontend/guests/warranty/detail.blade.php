...
{{--                                                            <td>{{ $warranty_detail->warranty_rule->warranty_product->product_name }}</td>--}}
                                                        ...
                                                        <td colspan="2" style="text-align: center;">
                                                            <button id="change-recognizee-btn" index="add" style="text-align: center;" class="btn btn-success">
                                                                <a href="{{ url('/warranty/add_premium/'.$warranty_detail->warranty_code) }}" style="color:white;">增加保额</a></button>
                                                            <?php $time = date('Y-m-d',time());
                                                                if($warranty_detail->end_time>$time){
                                                                    echo '<button id="change-recognizee-btn" index="add" style="text-align: center;" class="btn btn-success">退保</button>';
                                                                }
                                                            ?>
                                        ...
                                        <h3><p>被保人信息</p></h3>
                                        <button><a href="{{ url('/warranty/add_recognizee/'.$order_detail->id) }}" style="color:white;">增加被保人</a></button>
                                        <div class="panel-group accordion" id="bill">
                                            <div class="panel panel-default">
                                                <div class="panel-heading">
                                                    <h4 class="panel-title">
                                                     ...
                                                     <div id="bill-block" class="panel-collapse ">
                                                        <div class="panel-body" style="padding-bottom: 0">
                                                            <table id="product" class="table table-hover" style="clear: both">
                                                                ...
                                                                <td colspan="2" style="text-align: center;">
                                                                    {{--<button id="change-recognizee-btn" index="add" style="text-align: center;" class="btn btn-success"><a href="/warranty/change_recognizee_btn" style="color: white;">修改被保人信息</a></button>--}}

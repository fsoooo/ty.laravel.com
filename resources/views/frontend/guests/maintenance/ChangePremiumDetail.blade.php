                        ...
                        <div class="main-box clearfix" style="min-height: 1100px;">
                            <div class="tabs-wrapper tabs-no-header">
                                <ul class="nav nav-tabs">
                                    <li><a href="{{ url('/maintenance/change_premium') }}">保额变更</a></li>
                                    <li class="active"><a href="#">保额修改详情</a></li>
                                </ul>

                                <div class="tab-content">
                                    <div class="tab-pane fade in active" id="tab-accounts">
                                        <h3><p>保单 {{ $premium_detail[0]->maintenance_record_order->warranty_rule->warranty->warranty_code }} 的保额修改记录</p></h3>
                                                ...
                                                <div class="panel panel-default">
                                                    ...
                                                    <div id="account-message-{{$value->id}}" class="panel-collapse collapse in">
                                                        <table id="basic" class="table table-hover" style="clear: both">
                                                            ...
                                                            <tr>
                                                                <td>修改保额</td>
                                                                <td>{{ json_decode($value->change_content)->premium }}</td>
                                                            </tr>
                                                            </tbody>
                                                        </table>
                                                    </div>

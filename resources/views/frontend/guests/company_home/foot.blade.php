    ...
    <ul class="clearfix">
        <li class="footer-list1">
            <div class="footer-img">
                <img src="{{config('view_url.company_url').'image/line.png'}}" alt="" />
            </div>
        ...
        <li class="footer-list2">
            <div class="footer-img">
                <img src="{{config('view_url.company_url').'image/about.png'}}" alt="" />
            </div>
        ...
        <li class="footer-list3">
            <div class="footer-img">
                <img src="{{config('view_url.company_url').'image/helper.png'}}" alt="" />
            </div>
        ...
        <li class="footer-list4">
            <div class="footer-img">
                <img src="{{config('view_url.company_url').'image/else.png'}}" alt="" />
            </div>
            ...
            <div class="footer-download clearfix">
                <div class="footer-download-img fl">
                    <img src="{{config('view_url.company_url').'image/微信图片_20170803113628.png'}}" alt="" />
                </div>

...
@section('content')
    <div class="main-block">
        <div class="main-left">
            ...
            @if(!is_null($forminfo))
                <form class="form-horizontal" method="post"  id="form" action="{{ url('product/insure_submit')}}" onsubmit="return toVaild()">
                    {{ csrf_field() }}
                    <input type="text" name="product_id" value="{{ $product_id }}" hidden>
                    <input type="text" name="identification" value="{{ $identification }}" hidden>
                    <input type="text" name="product_number" value="{{ $product_number }}" hidden>
                    ...
                    <div class="relation">
                        <div class="input-block">
                            ...
                            <select  class="common-input" name="holdInsRelation">
                                @foreach($relation['content'] as $value)
                        ...
                        <div class="input-block">
                            ...
                            <input type="date" name="startTime" class="common-input" value="{{$forminfo['startTime']}}">
                            <span class="error-message"></span>
                        </div>
                    </div>
                    <div class="policy-message">
                        ...
                        <div class="input-block">
                            <label for="">姓名</label>
                            <input type="text" class="common-input" placeholder="投保人姓名" name="holderName" value="{{$forminfo['holderName']}}">
                            <span class="error-message"></span>
                        </div>
                        <div class="input-block">
                            <label for="">证件类型</label>
                            <select class="common-input code-select" name="holderIdType">>
                                @foreach($card_type['content'] as $value)
                                    <option value="{{$value->number}}">{{$value->name}}</option>
                                @endforeach
                            </select>
                            <input type="text" class="code-input" placeholder="请输入证件号" name="holderIdNumber" value="{{$forminfo['holderIdNumber']}}">
                            <span class="error-message"></span>
                        </div>
                        <div class="input-block">
                            <label for="">详细地址</label>
                            <input type="text" class="common-input" placeholder="详细地址" name="holderAddress" value="{{$forminfo['holderAddress']}}">
                            <span class="error-message"></span>
                        </div>
                        <div class="input-block">
                            <label for="">职业</label>
                            <select class="common-input" name="holderOccupation">
                                @foreach($occupation['content'] as $value)
                                    <option value="{{$value->number}}">{{$value->name}}</option>
                                @endforeach
                            </select>
                            <span class="error-message"></span>
                        ...
                        <div class="input-block">
                            <label for="">手机号</label>
                            <input type="text" class="common-input" placeholder="手机号码" name="holderPhone" value="{{$forminfo['holderPhone']}}">
                            <span class="error-message"></span>
                        </div>
                        <div class="input-block">
                            <label for="">电子邮箱</label>
                            <input type="email" class="common-input email-input" placeholder="邮箱地址" name="holderEmail" value="{{$forminfo['holderEmail']}}">
                            <span class="error-message"></span>
                        </div>
                    ...
                    <div class="recognizee-message">
                        ...
                        <div class="input-block">
                            <label for="">姓名</label>
                            <input type="text" class="common-input"  placeholder="被保人姓名" name="insuredName" value="{{$forminfo['insuredName']}}">
                            <span class="error-message"></span>
                        </div>
                        <div class="input-block">
                            <label for="">证件类型</label>
                            ...
                            <input type="text" class="code-input" placeholder="请输入证件号" name="insuredIdNumber" value="{{$forminfo['insuredIdNumber']}}">
                            <span class=""></span>
                        </div>
                        <div class="input-block">
                            <label for="">手机号</label>
                            <input type="text" class="common-input" placeholder="选择添加" name="insuredPhone" value="{{$forminfo['insuredPhone']}}">
                            <span class="error-message"></span>
                        </div>
                        <div class="input-block">
            ...
            <form class="form-horizontal" method="post"  id="form" action="{{ url('product/insure_submit')}}" onsubmit="return toVaild()">
                ...
                <div class="relation">
                    ...
                    <div class="input-block">
                        <label for="">起保日期</label>
                        <input type="date" name="startTime" class="common-input">
                        <span class="error-message"></span>
                    </div>
                </div>
                <div class="policy-message">
                    ...
                    <div class="input-block">
                        <label for="">姓名</label>
                        <input type="text" class="common-input" placeholder="投保人姓名" name="holderName">
                        <span class="error-message"></span>
                    </div>
                    <div class="input-block">
                        <label for="">证件类型</label>
                        ...
                        <input type="text" class="code-input" placeholder="请输入证件号" name="holderIdNumber">
                        <span class="error-message"></span>
                    </div>
                    <div class="input-block">
                        <label for="">详细地址</label>
                        <input type="text" class="common-input" placeholder="详细地址" name="holderAddress">
                        <span class="error-message"></span>
                    </div>
                    <div class="input-block">
                        <label for="">职业</label>
                    ...
                    <div class="input-block">
                        <label for="">手机号</label>
                        <input type="text" class="common-input" placeholder="手机号码" name="holderPhone">
                        <span class="error-message"></span>
                    </div>
                    <div class="input-block">
                        <label for="">电子邮箱</label>
                        <input type="email" class="common-input email-input" placeholder="邮箱地址" name="holderEmail">
                        <span class="error-message"></span>
                    </div>
                    <div class="default-connect input-block">
                        <label for=""></label>
                ...
                <div class="recognizee-message">
                    ...
                    <div class="input-block">
                        <label for="">姓名</label>
                        <input type="text" class="common-input"  placeholder="被保人姓名" name="insuredName">
                        <span class="error-message"></span>
                    </div>
                    <div class="input-block">
                        <label for="">证件类型</label>
                        ...
                        <input type="text" class="code-input" placeholder="请输入证件号" name="insuredIdNumber">
                        <span class=""></span>
                    </div>
                    <div class="input-block">
                        <label for="">手机号</label>
                        <input type="text" class="common-input" placeholder="选择添加" name="insuredPhone">
                        <span class="error-message"></span>
                    </div>
                    <div class="input-block">
                        <label for="">缴别[年]</label>

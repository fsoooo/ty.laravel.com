            ...
            <div class="notification-left fl">
                ...
                <div class="notification-left-content">
                    @foreach(json_decode($input['ins'],true)['insurance_attributes'] as $k => $v)
                                    ...
                                    @if($v['module_key'] == 'ty_beibaoren')
                                        <table class="content-table-detail">
                                            ...
                                            @foreach($insured_lists as $ik => $iv)
                                                    <tr>
                                                        <td>{{$iv['ty_beibaoren_name']}}</td>
                                                        <td>{{$iv['ty_beibaoren_id_number']}}</td>
                                                        <td>{{$iv['ty_beibaoren_job']}}</td>
                                                        <td>{{$iv['ty_beibaoren_phone']}}</td>
                                                    </tr>
                                            @endforeach
                                        </table>
                                    @endif
                        ...
                        @endif
                    @endforeach
                    <div class="buttonbox"><button class="btn btn-a4d790" onclick="history.go(-1)">修改信息</button><button class="btn btn-f18164" onclick="insureSubmit()">提交订单</button></div>
                </div>
            </div>

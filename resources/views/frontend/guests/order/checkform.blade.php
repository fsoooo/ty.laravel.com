        ...
        <div class="main-left">
            ...
            <form class="form-horizontal" id="myForm" action="/order/submit_change" onsubmit="return toVaild()">
                ...
                <div class="policy-submit">
                    {{--<input id="submit" type="submit" value="确认变更">--}}
                    <input type="button" value="确认变更" onclick="toVaild()">
            ...
            <script>
                function toVaild() {
                    var txt="&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;                                                       " +
                        "天眼互联温馨提示："+"<br/>"+"&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;变更保单时将原保单退保，并生成一张新的订保单，请您确认是否需要变更？";
                    var option = {
                        btn: parseInt("0003",4),
                        onOk: function(){
                            return false;
                    ...
                    if(window.wxc.xcConfirm(txt, "custom", option)){
                    }else{
                        setTimeout(function(){

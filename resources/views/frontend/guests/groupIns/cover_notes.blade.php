...
@section('content')
        ...
        <div class="main notification clearfix">
            <div class="notification-left fl">
                <div class="notification-left-tip">
                    <i class="iconfont icon-yduidunpaishixin"></i><span>11为了保障您的权益，请填写真实有效的信息。您填写的内容仅供投保使用，对于您的信息我们会严格保密。</span>
                </div>
    ...
    <script>
        ...
        $('.btn').click(function(){
            @if($res == 2)
                    window.location.href = '/ins/group_ins/insure/'+identification;

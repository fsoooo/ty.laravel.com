    ...
    <div id="product" class="main-wrapper">
        <div class="row">
            <div class="select-wrapper radius">
                <form role="form" class="form-inline radius" id="sel-top" action="{{url('/backend/set_brokerage/list')}}">
                    <div class="form-group">
                        <div class="select-item">
                            <label for="name">选择产品:</label>
                        ...
                        <div class="select-item">
                            ...
                            <select class="form-control select_top" name="ditch_id">

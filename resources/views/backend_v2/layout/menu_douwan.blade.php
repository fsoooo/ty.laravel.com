...
<div class="menu-wrapper">
    <ul>
        ...
        {{--<li {{$order}}><a href="{{url('/backend/order')}}"><i class="iconfont icon-kehu"></i>订单管理</a></li>--}}
        {{--<li {{$policy}}><a href="{{url('/backend/policy')}}"><i class="iconfont icon-kehu"></i>保单管理</a></li>--}}
        <li {{$channel_douwan}}><a href="{{url('/backend/channels/douwan')}}"><i class="iconfont icon-xing"></i>投保管理</a></li>

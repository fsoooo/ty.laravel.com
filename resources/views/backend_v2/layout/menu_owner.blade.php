...
<div class="menu-wrapper">
    <ul>
        <li ><a href="{{url('/backend')}}"><i class="iconfont icon-shouye"></i>首页</a></li>
        <li ><a href="{{url('backend/role/roles')}}"><i class="iconfont icon-dailiren"></i>产品统计</a></li>
        <li ><a href="{{url('backend/role/permissions')}}"><i class="iconfont icon-chanpin"></i>销售统计</a></li>
        <li ><a href="{{url('backend/role/role_bind_permission') }}"><i class="iconfont icon-xing"></i>角色权限关联</a></li>
        <li ><a href="{{url('backend/role/user_bind_roles')}}"><i class="iconfont icon-qudao"></i>角色关联</a></li>
    </ul>
</div>

...
class YundaCallback extends Command
{
    ...
    {
        echo '开始时间' . date('Y-m-d H:i:s', time()) . '<br/><br/>';
        LogHelper::logChannelSuccess(date('Y-m-d H:i:s', time()), 'YD_call_back_start_time');
...
//                ->get();
        ...
        LogHelper::logChannelSuccess(date('Y-m-d H:i:s', time()), 'YD_call_back_end_time');
        return 'end';
    }
}

...
class RoleController extends BaseController
{
    ...
    public function roles()
    {
        ...
        return view('backend_v2.role.roles',compact('roles'));
    }
    /**
     * @return mixed
     *角色添加
    ...
    public function Permissions()
    {
        ...
        return view('backend_v2.role.permissions',compact('permissions'));
    }
    /**
     * @return mixed
     * 权限添加
    ...
    public function addPermissionPost()
    {
        ...
        if ($validator->fails()) {
            return redirect('backend/role/permissions')
                ->withErrors($validator)
                ->withInput();
        }
        //添加
    ...
    {
        $roles = Role::get();//角色
        $permissions = Permission::get();//权限
        return view('backend_v2.role.role_bind_permission',compact('roles','permissions'));
    }
    /**
     * @return mixed
     * 角色权限关联查询
...
//            $q->where('permission_id',3);  //渴求式加载
        ...
        return view('backend_v2.role.role_bind_permission',compact('role', 'roles','role_permission_ids', 'permissions','role_id'));
    }
...
//    =======================账户 && 角色==============================
    ...
    public function userBindRoles(){
        $users = AdminUser::all();
        return view('backend_v2.role.user_bind_roles',compact('users'));
    }
...
//            $q->where('permission_id',3);  //渴求式加载
        ...
        return view('backend_v2.role.user_bind_roles',compact('user', 'users','user_role_ids', 'roles'));
    }
